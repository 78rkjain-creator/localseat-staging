...
export function DashboardTabs({ tabs, children, defaultTab }: DashboardTabsProps) {
  ...
  return (
    <div>
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={[
                "relative px-4 py-2 text-sm font-medium rounded-t-xl transition-colors",
                isActive
      ...
      {/* Folder body */}
      <div
        className="bg-white rounded-b-2xl rounded-tr-2xl border border-slate-200 p-4 shadow-sm"
        role="tabpanel"
      >
        {activeContent}
      </div>
