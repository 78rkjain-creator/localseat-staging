...
// Version history is tracked by termsVersion on the User record.
// When terms are updated, increment CURRENT_TERMS_VERSION and add a new
// HTML constant below.

export const CURRENT_TERMS_VERSION = "1.4";

// ── Terms v1.1 ─────────────────────────────────────────────────────────────
// Used at registration. Rendered as formatted HTML inside the scrollable box.

export const TERMS_V1_1_HTML = `
<h2>LocalSeat.io Terms and Conditions</h2>
<p><strong>Version 1.1 — Effective April 16, 2026</strong></p>
<p>
...
<h3>2. Account Registration and Eligibility</h3>
<p>
...
<p>
  ...
  data in violation of Canada's <em>Personal Information Protection and
  Electronic Documents Act</em> (PIPEDA) or applicable provincial privacy
  legislation.
</p>
<p>
...
<p>
  ...
  messages in violation of Canada's <em>Anti-Spam Legislation</em> (CASL).
</p>

<h3>4. Data, Privacy, and Your Obligations</h3>
<p>
  4.1. <strong>Your data.</strong> All campaign data you enter or import into
  the Platform ("Campaign Data") remains yours. We process it solely to
  operate the Platform on your behalf.
</p>
<p>
  4.2. <strong>Our data handling.</strong> We take commercially reasonable
...
<p>
  4.3. <strong>Voter and constituent data.</strong> You are the data controller
...
<p>
  4.4. <strong>Post-campaign data provisions.</strong> Following the conclusion
  of your campaign — whether by election result, account cancellation, or
  expiry — your Campaign Data will be retained for a period of <strong>90
  days</strong> to allow you to export or retrieve it. During this retention
...
<p>
  4.5. <strong>Constituent notifications.</strong> You are responsible for
...
<p>
  4.6. <strong>Data deletion rights.</strong> You have the right to request
  ...
  Campaign Data within <strong>30 days</strong>, except where retention is
...
<h3>5. Subscription, Payment, and Cancellation</h3>
<p>
...
<p>
  ...
  <a href="mailto:legal@localseat.io">legal@localseat.io</a>.
</p>

<p class="terms-version">LocalSeat.io Terms and Conditions — Version 1.1</p>
`;

// ── Terms v1.2 ─────────────────────────────────────────────────────────────
// Used at registration. Rendered as formatted HTML inside the scrollable box.

export const TERMS_V1_2_HTML = `
<h2>LocalSeat.io Terms and Conditions</h2>
<p><strong>Version 1.2 — Effective April 18, 2026</strong></p>
<p>
  Please read these Terms and Conditions ("Terms") carefully before creating
  an account on LocalSeat.io ("the Platform", "we", "our"). By registering
  and signing below, you agree to be bound by these Terms in full.
...
<p>
  4.4. <strong>Platform improvement and predictive modelling.</strong> We may
  use de-identified, aggregated Campaign Data to develop, train, and improve
  platform features including predictive analytics and voter modelling tools.
  Before any such use, all data is stripped of personally identifiable
  information including names, addresses, phone numbers, and email addresses.
  No individual constituent can be identified from the data used for this
  purpose. This use does not constitute a sale or transfer of Campaign Data
  and is subject to the restrictions in Section 4.5 regarding Financial Data.
  We will never sell, license, rent, or transfer Campaign Data or any
  derivative thereof to any third party for any commercial, political, or
  other purpose.
</p>
<p>
  4.5. <strong>Constituent notifications.</strong> You are responsible for
...
<p>
  5.3. You may cancel your subscription at any time. Cancellation takes effect
  at the end of the then-current billing period. Following cancellation, the
  platform improvement and data use provisions in section 4.4 apply.
</p>
<p>
  5.4. We reserve the right to modify pricing with at least 30 days' written
  notice. Continued use of the Platform after a price change constitutes
...
<p class="terms-version">LocalSeat.io Terms and Conditions — Version 1.2</p>
`;

// ── Terms v1.3 ─────────────────────────────────────────────────────────────
// Used at registration. Rendered as formatted HTML inside the scrollable box.

export const TERMS_V1_3_HTML = `
<h2>LocalSeat.io Terms and Conditions</h2>
<p><strong>Version 1.3 — Effective April 18, 2026</strong></p>
<p>
  Please read these Terms and Conditions ("Terms") carefully before creating
  an account on LocalSeat.io ("the Platform", "we", "our"). By registering
  and signing below, you agree to be bound by these Terms in full.
...
<p>
  4.7. <strong>Platform improvement and predictive modelling.</strong> We may
  use de-identified, aggregated Campaign Data to develop, train, and improve
  platform features including predictive analytics and voter modelling tools.
  Before any such use, all data is stripped of personally identifiable
  information including names, addresses, phone numbers, and email addresses.
...
<p class="terms-version">LocalSeat.io Terms and Conditions — Version 1.3</p>
`;

// ── Terms v1.4 ─────────────────────────────────────────────────────────────
// Used at registration. Rendered as formatted HTML inside the scrollable box.

export const TERMS_V1_4_HTML = `
<h2>LocalSeat.io Terms and Conditions</h2>
<p><strong>Version 1.4 — Effective April 20, 2026</strong></p>
<p>
  Please read these Terms and Conditions ("Terms") carefully before creating
  an account on LocalSeat.io ("the Platform", "we", "our"). By registering
  and signing below, you agree to be bound by these Terms in full.
...
<p>
  4.4. <strong>Data retention.</strong> LocalSeat retains your campaign data
  indefinitely after your campaign concludes. This is intentional — municipal
  candidates often return for future elections and may need access to their
  historical data. Your data will be available to you whenever you return to
  the platform. If you wish to have your campaign data permanently deleted, you
  may request this at any time by contacting info@localseat.io. We will confirm
  deletion within 30 days of your request.
</p>
<p>
  4.5. <strong>Constituent notifications.</strong> You are responsible for
  informing individuals whose personal information you have collected that such
...
<p>
  5.3. You may cancel your subscription at any time. Cancellation takes effect
  at the end of the then-current billing period. Following cancellation, the
  data retention provisions in section 4.4 apply.
</p>
<p>
  5.4. We reserve the right to modify pricing with at least 30 days' written
  notice. Continued use of the Platform after a price change constitutes
...
<p class="terms-version">LocalSeat.io Terms and Conditions — Version 1.4</p>
`;
