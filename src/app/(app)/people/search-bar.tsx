...
export function PeopleSearchBar({ defaultValue }: PeopleSearchBarProps) {
  ...
  // Debounce: push URL after 350ms of no typing.
  // We intentionally omit tag from the URL here — the tag param is preserved
  // server-side; search and tag filtering are independent.
  useEffect(() => {
